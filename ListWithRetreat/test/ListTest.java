...
public abstract class ListTest {
     ...
     * retreat, moveToStart, moveToFinish, leftLength, and rightLength.
     */
    ...
    /*
     * Test cases for RemoveRightFront
     */
    ...
    @Test
    public final void testAddRightFrontLeftEmptyRightOne() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(0, "blue");
        List<String> list2 = this.createFromArgsRef(0, "green", "blue");
        /*
         * Call method under test
         */
    ...
    @Test
    public final void testAddRightFrontLeftNonEmptyRightOne() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(3, "yellow", "orange",
    ...
    @Test
    public final void testMoveToStartLeftNonEmptyRightOne() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(3, "yellow", "orange",
    ...
    @Test
    public final void testRightLengthLeftEmptyRightOne() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(0, "blue");
    ...
    @Test
    public final void testLeftLengthLeftOneRightEmpty() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(1, "green");
        List<String> list2 = this.createFromArgsRef(1, "green");
        /*
         * Call method under test
         */
        int i = list1.leftLength();
    ...
    public final void testRetreatLeftNonEmptyRightEmpty() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(3, "yellow", "green",
                "blue");
        List<String> list2 = this.createFromArgsRef(2, "yellow", "green",
                "blue");
        /*
         * Call method under test
         */
    ...
    public final void testRetreatLeftOneRightNonEmpty() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(1, "yellow", "green",
                "blue", "red");
        List<String> list2 = this.createFromArgsRef(0, "yellow", "green",
                "blue", "red");
        /*
         * Call method under test
         */
